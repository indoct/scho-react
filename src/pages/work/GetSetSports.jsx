      ...
      <div className="container d-flex flex-column pt-4 pt-lg-5 justify-content-center">
        ...
        <div className="row pb-2 py-lg-3 project-images justify-content-center">
          <div className="col-12">
            <img
              src="../../src/images/gs/get-set-01.jpg"
          ...
          <div className="col-12">
            <img
              src="../../src/images/gs/get-set-02.jpg"
          ...
          <div className="col-12">
            <img
              src="../../src/images/gs/get-set-03.jpg"
          ...
          <div className="col-12">
            <img
              src="../../src/images/gs/get-set-04.jpg"
          ...
          <div className="col-12">
            <img
              src="../../src/images/gs/get-set-06.jpg"
              alt="ESF Join Us School Map Static"
              className="proj-img img-fluid"
            />
          </div>
          <div className="col-12">
            <img
              src="../../src/images/gs/get-set-07.jpg"
              alt="ESF Join Us School Map Static"
              className="proj-img img-fluid"
            />
          </div>
